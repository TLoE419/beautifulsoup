...
class BeautifulSoup(Tag):
    ...
    soup_replacer: Optional[SoupReplacer]  #: :meta private:
    ...
    def __init__(
        ...
        soup_replacer: Optional[SoupReplacer] = None,
        ...
        **kwargs: Any,
        ...
        :param soup_replacer: A SoupReplacer. Tags matching the SoupReplacer's
         criteria will be modified during parsing according to the specified
         action. This is more efficient than modifying tags after parsing
         since it avoids an additional tree traversal.
